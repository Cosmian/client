...
use cosmian_kms_rest_client::{
    ...
    import_object, read_bytes_from_file, read_object_from_json_ttlv_file, KmsRestClient,
};
...
impl ImportCertificateAction {
    pub async fn run(&self, kms_rest_client: &KmsRestClient) -> CliResult<()> {
    ...
    async fn import_pkcs12(&self, kms_rest_client: &KmsRestClient) -> CliResult<String> {
