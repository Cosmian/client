...
use crate::error::{result::ConfigResultHelper, ConfigError};
...
impl ClientConf {
    ...
    pub fn save(&self, conf_path: &PathBuf) -> Result<(), ConfigError> {
        fs::write(
            conf_path,
    ...
    pub fn load(conf_path: &PathBuf) -> Result<Self, ConfigError> {
